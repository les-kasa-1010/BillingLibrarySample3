...
package com.example.billingsample.purchase.util;
...
import static com.example.billingsample.model.PurchaseDataKt.SKU_STATIC_TEST;
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            try {
                ...
                if(!SKU_STATIC_TEST.equals(sku)){ // static response用は検証しない
                    // Verify signature
